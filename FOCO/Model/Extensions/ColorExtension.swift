...
// Adds support to system colors enums
extension UIColor {
    ...
    static let systemActionSheetBackground = UIColor(hue: 0, saturation: 0, brightness: 0.91, alpha: 1)

    // App Color Palette

    static let appDarkImperialBlue = UIColor(red: 0.11, green: 0.25, blue: 0.40, alpha: 1.0) // Action Texts
    static let appMediumElectricBlue = UIColor(red: 0.01, green: 0.35, blue: 0.53, alpha: 1.0)
    static let appBlueJeans = UIColor(red: 0.37, green: 0.71, blue: 0.85, alpha: 1.0)
    static let appCoral = UIColor(red: 1.00, green: 0.47, blue: 0.32, alpha: 1.0)
    static let appOrangeYellow = UIColor(red: 0.96, green: 0.83, blue: 0.38, alpha: 1.0) // Button Background
