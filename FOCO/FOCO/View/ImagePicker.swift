...
//  FOCO
//
//  Created by Ignácio Espinoso Ribeiro on 25/11/19.
//  Copyright © 2019 arbovirosis. All rights reserved.
//

import UIKit

// Implements Image Picking Functionalities to a view
...
open class ImagePicker: NSObject {
    ...
    public func present(from sourceView: UIView) {
        ...
        if let action = self.action(for: .photoLibrary, title: "Galeria de fotos") {
            alertController.addAction(action)
        }
